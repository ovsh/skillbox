...
/// Everything Skillbox knows about a registry checkout.
...
/// Record of one sync: every file Skillbox wrote, as home-relative paths.
/// This is what makes uninstall, prune, and previews possible.
public struct Lockfile: Codable, Sendable {
    public var version: Int
    /// Home-relative paths of every file Skillbox manages, e.g.
...
public struct AppSettings: Codable, Equatable, Sendable {
    ...
    public static var defaultCheckoutPath: String {
        ...
        return "\(home)/Library/Application Support/Skillbox/registry"
    }
