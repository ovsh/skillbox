...
struct UpdateChecker: Sendable {
    ...
    static let zipAssetName = "Skillbox-MacOS.zip"
    static let appBundleName = "Skillbox.app"
    ...
    func downloadAndInstall(from url: URL) async throws {
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("skillbox-update-\(UUID().uuidString)")
...
enum UpdateError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .appNotFound: return "Could not find Skillbox.app in the update."
