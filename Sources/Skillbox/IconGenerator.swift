...
enum IconGenerator {
    ...
    private static let spmResourceBundle: Bundle? = {
        let bundleName = "Skillbox_Skillbox"
        let candidates = [
    ...
    static func renderAppIconPNG() -> Data? {
        ...
        let sourceRoot = execURL
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
        let fallbackURL = sourceRoot.appendingPathComponent("Sources/Skillbox/Resources/AppIcon.png")
    ...
    static func generateICNS(to outputPath: String) -> Bool {
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("skillbox-iconset-\(ProcessInfo.processInfo.processIdentifier)")
